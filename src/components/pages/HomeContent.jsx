    ...
    <>
      ...
      <section ref={sectionRef} style={{
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: `<video autoplay loop playsinline muted preload="auto" poster="/images/tighremt/palmeraie-panorama.jpg" style="position:absolute;inset:0;width:100%;height:120%;object-fit:cover;top:-10%;filter:contrast(1.08) saturate(1.18) brightness(1.04);"><source src="/palmeraie-hd.mp4" type="video/mp4"><track kind="captions" src="/captions-fr.vtt" srclang="fr" label="Français"></video>` }}
        />
