...
const GLOBAL_CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hero-bg {
    background:
      linear-gradient(160deg, rgba(19,61,32,0.72) 0%, rgba(19,61,32,0.45) 45%, rgba(19,61,32,0.82) 100%),
    ...
    <nav style={{
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <a href="#" style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', textDecoration: 'none' }}>
          ...
          <div>
            <div style={{ fontFamily: 'Cormorant Garamond, serif', fontWeight: 600, fontSize: '1.05rem', color: logoCol, lineHeight: 1.1 }}>
              Palmeraies Tighremt
            </div>
        ...
        {/* Desktop links */}
        <div style={{ display: 'flex', gap: '2rem', alignItems: 'center' }} className="desktop-nav" data-hide-mobile>
          {links.map(l => (
            <a key={l} href="#" className="nav-link"
              style={{ fontSize: '0.88rem', fontWeight: 500, color: textCol, textDecoration: 'none' }}>
              {l}
            </a>
          ))}
        </div>
      ...
      {open && (
        <div style={{
          background: C.sand, borderTop: `1px solid ${C.sandDark}`,
          padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '0.25rem',
        }}>
          {links.map(l => (
            <a key={l} href="#"
              style={{ padding: '0.75rem 0', fontSize: '1rem', color: C.inkMuted, textDecoration: 'none', borderBottom: `1px solid ${C.sandDark}` }}
  ...
  return (
    <section className="hero-bg" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', padding: '0 1.5rem 5rem' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', width: '100%', paddingTop: '7rem' }}>
        ...
        {/* Stats strip */}
        <div className="reveal reveal-delay-4" style={{ display: 'flex', flexWrap: 'wrap' }}>
          {[
            ...
            <div key={s.val} className="stat-item">
              <div style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: '1.7rem', fontWeight: 600, color: '#fff', lineHeight: 1 }}>{s.val}</div>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%,480px),1fr))', gap: 'clamp(3rem,6vw,6rem)', alignItems: 'center' }}>
        ...
        <div className="reveal reveal-delay-2" style={{ position: 'relative' }}>
          ...
          <div style={{
            ...
            background: C.sandDark, border: `4px solid ${C.sand}`,
            display: 'flex', alignItems: 'center', justifyContent: 'center',
          }}>
...
function Actions() {
  return (
    <section id="actions" style={{ background: C.sandMid, padding: 'clamp(5rem,10vw,8rem) 1.5rem' }}>
          ...
          {ACTIONS.map(({ icon: Icon, title, desc, color, bgImage }, i) => (
            ...
            >
              ...
              <div style={{ height: 140, overflow: 'hidden', position: 'relative' }}>
                ...
                <div style={{ position: 'absolute', inset: 0, background: `linear-gradient(to bottom, transparent 40%, ${C.sand}cc)` }} />
                <div style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '3rem', paddingBottom: '3rem', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
          ...
          <div style={{ gridColumn: 'span 1' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', marginBottom: '1.25rem' }}>
              ...
              <div>
                <div style={{ fontFamily: 'Cormorant Garamond, serif', fontWeight: 600, fontSize: '1rem', color: '#fff', lineHeight: 1.1 }}>
                  Palmeraies Tighremt
                </div>
