...
const PROJECTS = [
  ...
  },
  {
    ...
    gallery: [
      { src: '/images/tighremt/ain-g1.jpg',  alt: "Bassin de rétention et seuil de béton sur l'oued d'Aïn" },
      { src: '/images/tighremt/ain-g2.jpg',  alt: "Retenue d'eau face à la palmeraie et au village" },
      { src: '/images/tighremt/ain-g3.jpg',  alt: 'Plan d\'eau formé derrière le seuil de captage' },
      { src: '/images/tighremt/ain-g4.jpg',  alt: 'Rouleau de grillage pour la confection des gabions' },
      { src: '/images/tighremt/ain-g5.jpg',  alt: 'Excavation des fondations du seuil' },
      { src: '/images/tighremt/ain-g6.jpg',  alt: "Berge aménagée du bassin d'Aïn" },
      { src: '/images/tighremt/ain-g7.jpg',  alt: "Travaux en cours sur l'oued d'Aïn" },
      { src: '/images/tighremt/ain-g8.jpg',  alt: 'Avancement de la construction du seuil' },
      { src: '/images/tighremt/ain-g9.jpg',  alt: 'Chantier — étape intermédiaire' },
      { src: '/images/tighremt/ain-g10.jpg', alt: "Vue large du site d'aménagement" },
      { src: '/images/tighremt/ain-g11.jpg', alt: 'Finalisation du bassin de rétention' },
      { src: '/images/tighremt/ain-g12.jpg', alt: "Visite préalable du site — novembre 2016" },
      { src: '/images/tighremt/ain-g13.jpg', alt: 'Reconnaissance du site avant les travaux' },
    ],
  },
  {
    id: 'humanitaire',
